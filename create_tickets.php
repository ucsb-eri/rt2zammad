...
class rt2zammad {
	...
	function byTicket(){
		$sql = "SELECT Tickets.id AS rt_tid,Tickets.Queue AS rt_tqueue,Tickets.Status AS rt_tstatus from Tickets WHERE rt_tstatus IN ('new','open','resolved') AND rt_tid between 1 AND 1000 ORDER by rt_tid;";
